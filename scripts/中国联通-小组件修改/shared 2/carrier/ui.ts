...
function normalizeMediumHourlyBarBaseMB(v: unknown): number {
  const n = Number(v)
  return n === 100 || n === 300 || n === 500 || n === 1024 || n === 2048 ? n : DEFAULT_UI.mediumHourlyBarBaseMB
}
...
export function pickUiSettings(src?: UiSwitchSource): UiSettings {
  ...
  return {
    ...
    mediumHourlyBarBaseMB: normalizeMediumHourlyBarBaseMB((s as any).mediumHourlyBarBaseMB),
