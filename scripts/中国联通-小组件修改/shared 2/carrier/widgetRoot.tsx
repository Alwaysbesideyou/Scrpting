  ...
  if (Widget.family === "systemMedium") {
    return (
      <MediumLayout
        ...
        flowUsed={useTotalFlow ? totalStat.used : flowStat.used}
        flowTotal={useTotalFlow ? totalStat.total : flowStat.total}
        usageBars={data.usageBars}
        ...
        otherUsed={useTotalFlow ? undefined : otherStat.used}
        otherTotal={useTotalFlow ? undefined : otherStat.total}
